  ...
  return (
    <html lang="th">
      <body className={`${kanit.className} font-sans antialiased`}>
        <nav className="fixed top-0 z-50 w-full bg-zinc-100 border-b border-gray-200">
          <div className="px-3 py-3 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center justify-start rtl:justify-end">
                ...
                <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Banfarmnum</span>
              </div>
            </div>
          </div>
        </nav>
        
        <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-zinc-100 border-b border-gray-200 sm:translate-x-0" aria-label="Sidebar">
        ...
        <div className="p-4 mt-15 sm:ml-64">
        {children}
        </div>
