                ...
                <div className='md:w-180'>
                    <div className="bg-amber-100 p-4 rounded-xl flex items-center md:gap-4">
                        ...
                        <div className='bg-white p-10 rounded-xl md:w-100 h-100'>
                            ...
                            <div className='text-4xl text-center mt-10'>เข้าสู่ระบบ</div>

                            <div className='flex p-2 mt-8 items-center gap-2'>
                            ...
                            <div className='flex p-2 mt-5 items-center gap-2'>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="size-5">
                            ...
                            <div className='place-content-between flex mt-2'>
