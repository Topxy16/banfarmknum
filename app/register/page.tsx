                            ...
                            <div className='mt-5 text-lg'>
                                <div>
                                    ...
                                    <div className='flex ml-8 gap-1'>
                                        <div className=''>
                                            <input type="text" placeholder="ชื่อ" className='border-b-3 border-green-950 mb-4 w-28' onChange={(e) => { setFname(e.target.value) }} />
                                        </div>
                                        <div className=''>
                                            <input type="text" placeholder="สกุล" className='border-b-3 border-green-950 mb-4 w-28' onChange={(e) => { setLname(e.target.value) }} />
                                        </div>
                                    </div>
                                </div>
                                <div className='flex items-center'>
