...
import AlertPupdate from './alertallaround'
...
export default function UpdateProductModal({ show, onClose }: UpdateProductModalProps) {
  if (!show) return null
    ...
    <div className="fixed inset-0 z-50 bg-white/30 backdrop-blur-sm flex items-center justify-center">
      <div className="bg-white rounded-xl shadow-xl w-90 max-w-md p-6">
        ...
        <div className="space-y-3">
          <div className='text-xl'>วันที่สั่ง</div>
          <input type="date" className='bg-gray-200 hover:bg-gray-300 rounded-xl p-2 w-full' />
          <div className='text-xl'>ข้อมูลผู้สั่ง</div>
          ...
          <div className='text-xl'>รายการสินค้า</div>
          <div className=''>
