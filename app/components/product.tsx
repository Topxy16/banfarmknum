...
export default function Product({ product, propsCategory }: propsProduct) {
    ...
    return (
        <div>
            <Alert message='ลบข้อมูลสินค้าสำเร็จ' detail='' show={setalert} onClose={() => { setAlert }} />
            <AlertF message='ลบข้อมูลสินค้าไม่สำเร็จ' detail='' show={setalertF} onClose={() => { setAlertF }} />
            <div>
