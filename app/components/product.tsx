    ...
    return (
        <div>
            <div className="phone m-2 bg-wi md:hidden">
                <div className="bg-white rounded-xl text-black text-xl p-4 shadow-xl mb-4 h-40">
                    <div className='flex'>
            ...
            <div className='pc hidden md:block'>
                <div className='w-full gap-4 grid grid-cols-4 mt-4'>
                    { product.map( (item,index) => (
                        <div key={index} className="mockupproduct bg-white rounded-xl text-black text-xl p-4 shadow-xl h-40">
                            <div className='flex'>
                                <div className='w-30 mt-2'>
                                    <Image
                                        src={neyor}
